...
func (x *AdvanceRequest) GetSession() string {
	if x != nil {
		return x.Session
	}
	return ""
...
func (x *AdvanceRequest) GetInputs() []*Message {
	if x != nil {
		return x.Inputs
	}
	return nil
...
func (x *AdvanceRequest) GetResumeFromSeq() int64 {
	if x != nil {
...
func (x *AdvanceRequest) GetHarness() string {
	if x != nil {
		return x.Harness
	}
	return ""
...
func (x *AdvanceRequest) GetConfig() []byte {
	if x != nil {
		return x.Config
	}
	return nil
...
func (x *AdvanceRequest) GetExpectedLastSeq() int64 {
	if x != nil {
...
func (x *AdvanceRequest) GetDeadlineUnix() int64 {
	if x != nil {
...
type AdvanceUpdate struct {
	...
	//
	//	*AdvanceUpdate_Record
	//	*AdvanceUpdate_Delta
	Update        isAdvanceUpdate_Update `protobuf_oneof:"update"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *AdvanceUpdate) Reset() {
	*x = AdvanceUpdate{}
...
func (x *AdvanceUpdate) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AdvanceUpdate) ProtoMessage() {}

func (x *AdvanceUpdate) ProtoReflect() protoreflect.Message {
	mi := &file_session_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AdvanceUpdate.ProtoReflect.Descriptor instead.
func (*AdvanceUpdate) Descriptor() ([]byte, []int) {
	return file_session_proto_rawDescGZIP(), []int{18}
}

func (x *AdvanceUpdate) GetUpdate() isAdvanceUpdate_Update {
	if x != nil {
		return x.Update
	}
	return nil
...
func (x *AdvanceUpdate) GetRecord() *LogRecord {
	if x != nil {
		if x, ok := x.Update.(*AdvanceUpdate_Record); ok {
			return x.Record
		}
	}
	return nil
...
func (x *AdvanceUpdate) GetDelta() *Delta {
	if x != nil {
		if x, ok := x.Update.(*AdvanceUpdate_Delta); ok {
			return x.Delta
		}
	}
	return nil
...
type isAdvanceUpdate_Update interface {
	isAdvanceUpdate_Update()
}

type AdvanceUpdate_Record struct {
	Record *LogRecord `protobuf:"bytes,1,opt,name=record,proto3,oneof"`
}

type AdvanceUpdate_Delta struct {
	Delta *Delta `protobuf:"bytes,2,opt,name=delta,proto3,oneof"`
}

func (*AdvanceUpdate_Record) isAdvanceUpdate_Update() {}

func (*AdvanceUpdate_Delta) isAdvanceUpdate_Update() {}
...
const file_session_proto_rawDesc = "" +
	...
	"\x03uid\x18\x01 \x01(\tR\x03uid\"\x88\x02\n" +
	"\x0eAdvanceRequest\x12\x18\n" +
	...
	"\asession\x18\x01 \x01(\tR\asession\x12!\n" +
	"\fexecution_id\x18\x02 \x01(\tR\vexecutionId\"\x81\x01\n" +
	"\rAdvanceUpdate\x125\n" +
	...
	"\x12COMPUTE_TERMINATED\x10\x052\xa4\a\n" +
	"\bSessions\x12R\n" +
	...
	"\rDeleteSession\x12&.agentsessions.v1.DeleteSessionRequest\x1a\x19.agentsessions.v1.Session\x12N\n" +
	"\aAdvance\x12 .agentsessions.v1.AdvanceRequest\x1a\x1f.agentsessions.v1.AdvanceUpdate0\x01\x12H\n" +
...
var file_session_proto_goTypes = []any{
	...
	(*AdvanceRequest)(nil),       // 12: agentsessions.v1.AdvanceRequest
	...
	(*AdvanceUpdate)(nil),        // 21: agentsessions.v1.AdvanceUpdate
...
var file_session_proto_depIdxs = []int32{
	...
	30, // 13: agentsessions.v1.AdvanceRequest.inputs:type_name -> agentsessions.v1.Message
	...
	31, // 17: agentsessions.v1.AdvanceUpdate.record:type_name -> agentsessions.v1.LogRecord
	22, // 18: agentsessions.v1.AdvanceUpdate.delta:type_name -> agentsessions.v1.Delta
	...
	12, // 23: agentsessions.v1.Sessions.Advance:input_type -> agentsessions.v1.AdvanceRequest
	...
	21, // 35: agentsessions.v1.Sessions.Advance:output_type -> agentsessions.v1.AdvanceUpdate
...
func file_session_proto_init() {
	...
	file_session_proto_msgTypes[18].OneofWrappers = []any{
		(*AdvanceUpdate_Record)(nil),
		(*AdvanceUpdate_Delta)(nil),
	}
	type x struct{}
